# 🌟 SESAC 성동 캠퍼스 - 클라우드 기반 AI융합 자바 풀스택 웹 개발자 과정
...
- **2025-11-05** : [ Java를 활용한 객체 지향 프로그래밍 - 클래스와 객체](https://github.com/qqqkyj/sesac-fullstack-training/tree/main/java/java/src/b/oop#-%EA%B0%9D%EC%B2%B4%EC%A7%80%ED%96%A5-%ED%94%84%EB%A1%9C%EA%B7%B8%EB%9E%98%EB%B0%8D-oop-object-oriented-programming)
...
- **2025-11-28** : [Spring Security - 인증/인가 로그인(세션)](https://github.com/qqqkyj/sesac-fullstack-training/blob/main/springboot/securitydemo/readme/README.md#9-spring-security)
...
- **2026-01-20** : [테스트 코드 작성(Given-When-Then)과 GitHub Actions 기반 CI/CD 배포 가이드(test-build-deploy)]()
